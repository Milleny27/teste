...
const VisitasDemo = () => {
    ...
    const fetchData = () => {
        axios
            .get('https://dosecerta.azurewebsites.net/api/Visita')
            .then((response) => {
    ...
    const saveVisita = () => {
        ...
        const request = selectedVisitaId ? axios.put(`https://dosecerta.azurewebsites.net/api/Visita/${selectedVisitaId}`, newVisita) : axios.post('https://dosecerta.azurewebsites.net/api/Visita', newVisita);
    ...
    const deleteVisita = () => {
        axios
            .delete(`https://dosecerta.azurewebsites.net/api/Visita/${visita.id}`)
            .then((response) => {
