...
const AnotacaoDemo = () => {
    ...
    const fetchData = () => {
        axios
            .get('https://dosecerta.azurewebsites.net/api/Notes')
            .then((response) => {
    ...
    const saveNote = () => {
        ...
        const request = selectedNoteId ? axios.put(`https://dosecerta.azurewebsites.net/api/Notes/${selectedNoteId}`, newNote) : axios.post('https://dosecerta.azurewebsites.net/api/Notes', newNote);
